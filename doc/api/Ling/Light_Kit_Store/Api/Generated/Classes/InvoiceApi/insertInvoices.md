...
InvoiceApi::insertInvoices
================



InvoiceApi::insertInvoices — Inserts the given invoice rows in the database.
...
Source Code
===========
See the source code for method [InvoiceApi::insertInvoices](https://github.com/lingtalfi/Light_Kit_Store/blob/master/Api/Generated/Classes/InvoiceApi.php#L98-L109)
