...
ItemApiInterface::getItemIdentifiersByUserId
================



ItemApiInterface::getItemIdentifiersByUserId — Returns an array of lks_item.identifier bound to the given user id.
...
Source Code
===========
See the source code for method [ItemApiInterface::getItemIdentifiersByUserId](https://github.com/lingtalfi/Light_Kit_Store/blob/master/Api/Generated/Interfaces/ItemApiInterface.php#L262-L262)
