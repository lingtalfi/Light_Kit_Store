...
Location
=============
Ling\Light_Kit_Store\Controller\Front\Account\YourAccountChangePasswordController<br>
See the source code of [Ling\Light_Kit_Store\Controller\Front\Account\YourAccountChangePasswordController](https://github.com/lingtalfi/Light_Kit_Store/blob/master/Controller/Front/Account/YourAccountChangePasswordController.php)



SeeAlso
==============
Previous class: [YourAccountBillingInfoController](https://github.com/lingtalfi/Light_Kit_Store/blob/master/doc/api/Ling/Light_Kit_Store/Controller/Front/Account/YourAccountBillingInfoController.md)<br>Next class: [YourAccountDownloadsController](https://github.com/lingtalfi/Light_Kit_Store/blob/master/doc/api/Ling/Light_Kit_Store/Controller/Front/Account/YourAccountDownloadsController.md)<br>
