...
Location
=============
Ling\Light_Kit_Store\Controller\Front\Store404Controller<br>
See the source code of [Ling\Light_Kit_Store\Controller\Front\Store404Controller](https://github.com/lingtalfi/Light_Kit_Store/blob/master/Controller/Front/Store404Controller.php)



SeeAlso
==============
Previous class: [YourAccountRatingsController](https://github.com/lingtalfi/Light_Kit_Store/blob/master/doc/api/Ling/Light_Kit_Store/Controller/Front/Account/YourAccountRatingsController.md)<br>Next class: [Store404ProductController](https://github.com/lingtalfi/Light_Kit_Store/blob/master/doc/api/Ling/Light_Kit_Store/Controller/Front/Store404ProductController.md)<br>
