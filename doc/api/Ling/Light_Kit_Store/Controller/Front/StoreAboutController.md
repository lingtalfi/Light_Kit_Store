...
The StoreAboutController class
================
...
Location
=============
Ling\Light_Kit_Store\Controller\Front\StoreAboutController<br>
See the source code of [Ling\Light_Kit_Store\Controller\Front\StoreAboutController](https://github.com/lingtalfi/Light_Kit_Store/blob/master/Controller/Front/StoreAboutController.php)



SeeAlso
==============
Previous class: [Store404ProductController](https://github.com/lingtalfi/Light_Kit_Store/blob/master/doc/api/Ling/Light_Kit_Store/Controller/Front/Store404ProductController.md)<br>Next class: [StoreHomeController](https://github.com/lingtalfi/Light_Kit_Store/blob/master/doc/api/Ling/Light_Kit_Store/Controller/Front/StoreHomeController.md)<br>
