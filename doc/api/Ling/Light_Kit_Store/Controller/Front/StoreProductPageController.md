...
- Methods
    ...
    - protected [getItem](https://github.com/lingtalfi/Light_Kit_Store/blob/master/doc/api/Ling/Light_Kit_Store/Controller/Front/StoreProductPageController/getItem.md)(int $itemId, ?array $options = []) : array | null
...
Location
=============
Ling\Light_Kit_Store\Controller\Front\StoreProductPageController<br>
See the source code of [Ling\Light_Kit_Store\Controller\Front\StoreProductPageController](https://github.com/lingtalfi/Light_Kit_Store/blob/master/Controller/Front/StoreProductPageController.php)



SeeAlso
==============
Previous class: [StorePagesListController](https://github.com/lingtalfi/Light_Kit_Store/blob/master/doc/api/Ling/Light_Kit_Store/Controller/Front/StorePagesListController.md)<br>Next class: [StoreRatingListController](https://github.com/lingtalfi/Light_Kit_Store/blob/master/doc/api/Ling/Light_Kit_Store/Controller/Front/StoreRatingListController.md)<br>
