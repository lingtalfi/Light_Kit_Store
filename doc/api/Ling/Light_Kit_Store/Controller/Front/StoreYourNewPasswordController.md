...
Location
=============
Ling\Light_Kit_Store\Controller\Front\StoreYourNewPasswordController<br>
See the source code of [Ling\Light_Kit_Store\Controller\Front\StoreYourNewPasswordController](https://github.com/lingtalfi/Light_Kit_Store/blob/master/Controller/Front/StoreYourNewPasswordController.php)



SeeAlso
==============
Previous class: [StoreWidgetsListController](https://github.com/lingtalfi/Light_Kit_Store/blob/master/doc/api/Ling/Light_Kit_Store/Controller/Front/StoreWidgetsListController.md)<br>Next class: [YourAccountConfirmed](https://github.com/lingtalfi/Light_Kit_Store/blob/master/doc/api/Ling/Light_Kit_Store/Controller/Front/YourAccountConfirmed.md)<br>
