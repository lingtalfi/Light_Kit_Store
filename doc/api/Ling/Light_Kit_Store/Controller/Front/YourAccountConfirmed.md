...
Location
=============
Ling\Light_Kit_Store\Controller\Front\YourAccountConfirmed<br>
See the source code of [Ling\Light_Kit_Store\Controller\Front\YourAccountConfirmed](https://github.com/lingtalfi/Light_Kit_Store/blob/master/Controller/Front/YourAccountConfirmed.php)



SeeAlso
==============
Previous class: [StoreYourNewPasswordController](https://github.com/lingtalfi/Light_Kit_Store/blob/master/doc/api/Ling/Light_Kit_Store/Controller/Front/StoreYourNewPasswordController.md)<br>Next class: [StoreApiController](https://github.com/lingtalfi/Light_Kit_Store/blob/master/doc/api/Ling/Light_Kit_Store/Controller/StoreApiController.md)<br>
