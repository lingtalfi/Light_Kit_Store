...
Source Code
===========
See the source code for method [LightKitStoreService::__construct](https://github.com/lingtalfi/Light_Kit_Store/blob/master/Service/LightKitStoreService.php#L71-L85)
